...
# Slice list to get a sublist that removes n elements at begin and n elements at end of list
def return_list_b_c():
    print("-----------------------------------------")
...
# With n from keyboard, get n first elements and n last elements, join them to make a new list of 2n elements
